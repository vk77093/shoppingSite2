    ...
    <div class="footer-info w3-agileits-info">
      ...
      <div class="col-sm-5 address-right">
        ...
        <div class="col-xs-6 footer-grids">
          ...
          <ul>
            <li>
              <i class="fa fa-map-marker"></i> Jalandhar Punjab</li>
            <li>
              <i class="fa fa-mobile"></i> 0181-somer Random </li>
            <li>
              <i class="fa fa-phone"></i>0181-somer Random</li>
            <li>
              <i class="fa fa-envelope-o"></i>
              <a href="mailto:example@mail.com">vk77093@gmail.com</a>
            </li>
          </ul>
        </div>
      </div>
...
<div class="copy-right">
  <div class="container">
    <p>© 2019. All rights reserved | Design by Vijay
      <a href="">The Right Is Right</a>
    </p>
  </div>
</div>
<!-- //copyright -->
